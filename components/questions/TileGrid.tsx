        ...
        {config.options?.map((option) => {
          ...
          return (
            <button
              ...
              className={`relative flex flex-col items-center justify-center p-4 rounded-2xl border-2 transition-all duration-200 min-h-[7rem] backdrop-blur-sm ${isSelected
