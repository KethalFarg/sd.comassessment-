    ...
    <div className={`relative flex flex-col h-full overflow-hidden ${isLight ? 'text-brand-dark' : 'text-white'}`}>
      ...
      <div className="flex flex-col h-full z-10 relative">
        ...
        <div className="flex-1 flex flex-col items-center text-center justify-center px-4">
          ...
          <p className={`text-lg leading-relaxed mb-8 max-w-md whitespace-pre-line ${isLight ? 'text-gray-600' : 'text-white/80'}`}>
            {config.subtext}
          </p>
        ...
        <div className="mt-auto pt-6 w-full flex justify-center pb-4">
          <button
            ...
            className="px-8 py-4 rounded-xl font-bold text-lg shadow-xl hover:scale-105 transition-transform flex items-center gap-2 bg-white text-brand-teal hover:bg-brand-lightTeal hover:text-white"
          >
