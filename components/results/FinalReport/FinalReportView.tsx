...
import StickyBottomSection from './StickyBottomSection';
...
const FinalReportView = ({
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="lg:hidden bg-white w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] py-8">
                <div className="max-w-6xl mx-auto px-6">
                    ...
                    <div className="flex items-center justify-center gap-2 mb-8">
                        ...
                        <span className="text-teal-primary font-medium text-sm">{patientName}</span>
                    </div>
            ...
            {/* Mobile-only gray gradient section */}
